...
En el universo de los 4 Fantásticos, la unión y el equilibrio entre los poderes es fundamental para enfrentar 
cualquier desafío. En este problema, nos centraremos en dos de sus miembros:
...
- Si la cantidad de R y la cantidad de J son iguales, se considera que la alianza entre la mente y 
...
- En el caso de que no aparezca ninguna de las dos letras en la cadena, se entiende que el equilibrio
 se mantiene (0 = 0), por lo que la función debe retornar True.

Ejemplos"""
import os
os.system('cls')
def equlibrio(cadena: str):
    cadena  = cadena.upper()
